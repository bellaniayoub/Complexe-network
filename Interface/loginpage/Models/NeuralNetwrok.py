...
if __name__ == "__main__":
    ...
    X_train, X_t, y_train, y_t = train_test_split(X, y, test_size=1/3, random_state=42)
    X_test, X_valide, y_test, y_valide = train_test_split(X_t, y_t, test_size=0.5, random_state=42)
    hist = neural.train(X_train,y_train, 16, 100,(X_valide, y_valide))
    neural.showProgress(hist)
    print("Test:")
